...
public class TQingzhuUser {
    ...
    public TQingzhuUser(Long userId, String nickName, String loginName, String passwordMd5, String introduceSign, String address, Byte isDeleted, Byte lockedFlag, Date createTime, Date updateTime) {
        this.userId = userId;
